...
/*
CalculateHashForCurrentLevel calculates the hash for value based on what level of the trie the operation is at. Hash is reseeded every 6 levels or 10 for the 64 bit hash
...
The 32 bit or 64 bit representation of the key
*/
